...
//PARA USAR DARK MODE AJUSTAR STYLE.CSS Y RETIRAR // A:
//document.getElementById("toggleTheme").addEventListener("click", toggleTheme);

// Cargar el tema preferido del almacenamiento local al iniciar
document.addEventListener("DOMContentLoaded", function(event) {
  var savedTheme = localStorage.getItem("theme") || "light"; // Si no hay preferencia guardada, usa el tema claro
  if(savedTheme === "dark") {
